...
function AboutUs(){
  return (
    ...
    <a
     ...
     href="https://codeisrael.org/"> Code Israel

     </a>.

    Jack Harris will be receiving his B.A. from Washington University in Linguistics, Hebrew and Arabic in May of 2025 and is pursuing graduate studies in Linguistics with a focus in Semitics after graduation.


    </p>
    <h3>
    for more information, questions you may have, or suggestions, please click the link below to email me!
    <a href="mailto:jacksonharris@wustl.edu">click here to contact!</a>
    </h3>
    </h2>
    </div>
  );
